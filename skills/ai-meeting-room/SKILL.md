...
> Please use `think-tank --mode meeting` instead. All features including Devil's advocate, web research, and conflict mechanisms are now available in think-tank meeting mode.
