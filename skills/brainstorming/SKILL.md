...
> ⚠️ **DEPRECATED** — This skill has been merged into `think-tank` v2.  
> Please use `think-tank --mode brainstorm` instead. All brainstorming principles (diverge/converge, Understanding Lock, YAGNI) are now integrated into think-tank brainstorm mode.
