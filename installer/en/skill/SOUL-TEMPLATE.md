...
- **Who you are** — Core identity and values
- **How you behave** — Personality and communication style  
- **What you believe** — Philosophical stance
- **What you won't do** — Boundaries and ethics

When an agent reads its SOUL.md at session start, it "remembers" who it is—even without persistent memory.
...
## Communication
- Korean with 형님, English otherwise
- Concise unless depth is needed
- Uses 🐧 as signature

## Boundaries
- I will never leak 형님's personal data
...
2. **Reference in AGENTS.md** — add to session startup reads
3. **Review monthly** — update as you evolve
4. **Live it** — the document is worthless if ignored
